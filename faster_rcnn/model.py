...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            model = KM.Model(inputs, outputs, name='mask_rcnn_wo_mask')
        else: ## Inference mode
            # Network Heads
